...
//   void initState() {
//     super.initState();
//     checkoutController.initializeRouter(
//       context,
//     ); // Initialize router in controller
...
//       }
//     });
//     checkoutController.updateFromRoute(context); // Initial route update
...
//   @override
//   void dispose() {
//     checkoutController.disposeRouter(); // Clean up router in controller
...
//           checkoutController.subtotal.value > 2500
//               ? 0.0
...
//                           ? BarlowText(
//                             text:
//                                 "Rs. ${(checkoutController.subtotal.value > 2500 ? 0.0 : checkoutController.totalDeliveryCharge.value).toStringAsFixed(2)}",
//                             color: const Color(0xFFFFFFFF),
//                             fontWeight: FontWeight.w400,
//                             fontSize: 16,
//                             lineHeight: 36 / 16,
...
//                       BarlowText(
//                         text:
//                             "Rs. ${(checkoutController.subtotal.value + (checkoutController.subtotal.value > 2500 ? 0.0 : checkoutController.totalDeliveryCharge.value)).toStringAsFixed(2)}",
//                         color: const Color(0xFFFFFFFF),
//                         fontWeight: FontWeight.w400,
//                         fontSize: 24,
//                         lineHeight: 36 / 16,
