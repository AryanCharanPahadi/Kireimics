...
class _CatalogMobileComponentState extends State<CatalogMobileComponent> {
  ...
  void initState() {
    super.initState();
    TitleService.setTitle("Kireimics | Catalog - Ceramic Mugs, Plates & Decor");
    ...
    if (catId != null && catId.isNotEmpty) {
      if (catId.toLowerCase() == 'collections') {
        setState(() {
          ...
          _selectedSortOption = 'Newest'; // Reset for collections
        ...
        if (categoryId != null) {
          setState(() {
            ...
            _selectedSortOption = 'New'; // Reset for products
  ...
  Future<void> _fetchCollections() async {
    ...
    try {
      ...
      setState(() {
        ...
        _isLoading = false;
        _selectedFilter = null;
        _selectedSortOption = 'Newest'; // Reset sort option
      });
    } catch (e) {
      setState(() {
        _isLoading = false;
  ...
  void onCategorySelected(int id, String name, String desc) {
    setState(() {
      ...
      _selectedFilter = null;
      _selectedSortOption =
          name.toLowerCase() == 'collections'
              ? 'Newest'
              : 'New'; // Reset sort option
