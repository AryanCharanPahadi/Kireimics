            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 24),
                  CralikaFont(text: "2. Information We Collect"),
                  SizedBox(height: 17),
                  BarlowText(
                    text:
                  ...
                  CralikaFont(text: "3. How We Use Your Information"),
                  SizedBox(height: 16),
                  ...
                  CralikaFont(text: "4. Sharing Your Information"),
                  SizedBox(height: 16),
                  BarlowText(
                    text:
                  ...
                  CralikaFont(text: "5. Data Security"),
                  SizedBox(height: 16),
                  BarlowText(
                    text:
                  ...
                  CralikaFont(text: "6. Your Rights"),
                  SizedBox(height: 16),
                  ...
                  CralikaFont(text: "7. Changes to This Policy"),
                  SizedBox(height: 16),
                  BarlowText(
                    text:
