...
class CollectionProductGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return CollectionProductGridItem(
...
class CollectionProductGridItem extends StatefulWidget {
  final int? productIds;
  ...
  @override
  State<CollectionProductGridItem> createState() =>
      _CollectionProductGridItemState();
}

class _CollectionProductGridItemState extends State<CollectionProductGridItem>
  ...
  @override
  void didUpdateWidget(covariant CollectionProductGridItem oldWidget) {
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        ...
                                        context.go(
                                          '${AppRoutes.productDetails(widget.product.id)}'
                                              '?collection_name=${Uri.encodeComponent(widget.product.collectionName ?? '')}'
